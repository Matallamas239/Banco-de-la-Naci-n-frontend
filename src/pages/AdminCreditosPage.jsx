        ...
        <Card title="Datos de la Solicitud" icon={<FilePlus2 size={18} />}>
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="hb-field" style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
              ...
              <label htmlFor="seguro" style={{ margin: 0, fontWeight: 600 }}>Incluye Seguro de Desgravamen (TEA 40.92%)</label>
            </div>
            ...
            {simulacionMonto > 0 && simulacionPlazo > 0 && (
              <div className="bbva-cuota-box" style={{ background: '#f0f4f8', borderColor: '#d0dbe5', color: '#0a2e5c', display: 'flex', flexDirection: 'column', alignItems: 'stretch', gap: 8, padding: 16, borderRadius: 12, marginTop: 15, marginBottom: 15 }}>
            ...
            <button type="submit" className="bbva-btn" disabled={loading} style={{ marginTop: 10 }}>
