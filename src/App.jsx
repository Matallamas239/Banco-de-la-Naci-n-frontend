...
import AdminRecuperacionesPage from './pages/AdminRecuperacionesPage.jsx'
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/admin/recuperaciones" element={<PrivateLayout><AdminRecuperacionesPage /></PrivateLayout>} />
