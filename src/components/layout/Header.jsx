            ...
            {!isAdmin && (
              ...
              >
                ...
                <div style={{
                  ...
                  height: '14px',
                  borderRadius: '999px',
                  background: hideAmounts ? '#F5A800' : 'rgba(255,255,255,0.3)',
                  position: 'relative',
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                      {!isAdmin && (
                        <button 
                          ...
                          onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#f3f4f6'; e.currentTarget.style.color = '#003087'; }}
      ...
      >
            ...
            return (
              ...
              >
                {active && !sidebarCollapsed && (
                  <div style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: '4px', background: '#F5A800' }} />
                )}
        ...
        <div style={{ padding: '20px 12px 0 12px', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
          <button
            ...
            onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(0, 48, 135, 0.15)'}
            onMouseLeave={(e) => e.currentTarget.style.background = 'rgba(255, 255, 255, 0.05)'}
          >
            <LogOut size={18} style={{ color: '#003087', flexShrink: 0 }} />
