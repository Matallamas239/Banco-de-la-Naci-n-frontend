...
import { LogOut, UserCog, Eye, EyeOff, ChevronDown, BarChart3, Users, Database, LayoutDashboard } from 'lucide-react'
      ...
      <div className="bbva-topbar">
        <div className="bbva-topbar-inner">
          <button className="bbva-brand" onClick={() => navigate('/inicio')} aria-label="Inicio">
            <Logo size={36} variant="dark" subtitle={isAdmin ? 'ADMINISTRACIÓN' : 'BANCA POR INTERNET'} />
          </button>
